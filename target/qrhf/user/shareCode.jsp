...
<%
	...
	String shareCode=user.getLoginName();
...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#data-table').bootstrapTable({
	    	url: '<%=basePath%>coupon/findList.action',
			method: 'post',
...
// 				    align: "center",
         ...
         function operateFormatter(value, row, index) {
			 	if (row.isValid ==1) {
			 		 return ['<a role="button" onclick="getAuth('+row.id+','+row.promotionId+','+row.promotionCompanyId+','+row.withdrawMoney+')">提现</a>&nbsp;&nbsp;&nbsp;'
		                    ].join(''); 
	          	}
            }
	 ...
	 function getAuth(id,userId,companyId,withdrawMoney) {
		location.href="<%=basePath%>user/addInfo.jsp?couponId="+id+"&userId="+userId+"&companyId="+companyId+"&withdrawMoney="+withdrawMoney;
	} 
</script>
</head>
<body id="listBody">
