...
                },
	            ...
	            },
				{
					...
					formatter:function(value,row,index){
						var html = "";
						if(row.ideas!=null && row.ideas.indexOf(",")>0)
						var ideaList = row.ideas.split(",");
						if(ideaList!=null){
							for(var i=0;i<ideaList.length-1;i++){
								html += ideaList[i] + "<br>";
							}
						}
						return html;
	...
	function edit(id) {
		window.location.href="<%=basePath%>project/edit.jsp?projectUpdateGoodsId="+id;
	}
